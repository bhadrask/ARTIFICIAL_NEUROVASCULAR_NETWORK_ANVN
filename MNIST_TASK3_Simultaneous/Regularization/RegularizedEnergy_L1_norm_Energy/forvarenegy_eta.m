function forvarenegy_eta(vas_ln, k, vas_dim, vas_energy_mat, vas_trials, mlp_train_images, ...
                         mlp_train_labels, mlp_test_images, mlp_test_labels, mlp_epoch, ...
                         mlp_save_every, mlp_eta_max, mlp_eta_min, mlp_train_size, mlp_test_size, wallowable_int)
...
%             mi=min(db1)
        ...
        parsave(vas_ln, percap_energy_con, mlp_train_success, mlp_test_success, str_dele, wallowable_int,ENDsave_energy,init_energy,deldW1,deldW2);
    end
end