...
vas_ln_mat =500;%[16,24,32,42,52,64,72,80,96,100:25:500];% [16,32,64,72,80,96,100:25:500];%[10:20:100,150:50:500];%[20,24,28,36,40,44,48,52,56];%[16,32,64,72,80,96,100:25:500]; %[64,125:50:800];
...
parfor i = 1:numel(wallowable_fraction)
    kmat =16;%[3*ones(1,2),4*ones(1,4),8*ones(1,12),16*ones(1,8)];% [3,4*ones(1,2),8*ones(1,3)];%%%[4, 8*ones(1,8), 16*ones(1,6)];
