...
mlp_epoch = 20000;
colorc = jet(100);
wallowable_fr =0.2:0.2:3;

vas_ln_mat =[80,500]%[16,24,32,42,52,64,72,80,96,100:50:500];%[16,32,64,100,300,500];%[16,20,24,28,32,36,40,44,48,52,56,64,72,80,96,100:25:500];%[64,125:50:800];%525;%[64,100:25:900];%[64,100:25:500];%,350:25:575];%[64,100,200,300,400,425,450,475,500,525,550] ;%[64,100:25:575];%[64,100:100:400,475:5:525,550:25:700,800:100:2200];%,800:100:2200];%[64,100:100:1000];%[32,50:50:1000];%[16,256,512,768,1024,2048];
...
%         str=strcat('D:\github_desktop\Vascular_Tree\task_3_parallel\adapted_wallowable\debug_525\negative_fb_-0.005\ln_',num2str(vas_ln_mat(j)),'_wallow_',num2str(wallowable(i)),'_trial_1.mat');
 str=strcat('C:\Users\Bhadra\Documents\GitHub\Vascular_Tree\task3_parallel_R_regularisedEnergy\rerun1_0.0005_Lm\ln_',num2str(vas_ln_mat(j)),'_wallow_',num2str(wallowable(i)),'_trial_1.mat');
