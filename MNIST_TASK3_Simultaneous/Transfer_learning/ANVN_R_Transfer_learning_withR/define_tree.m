function [Ntot, tree_Weight, tree_Energy, tree_A, tree_Nlevel, tree_leaf_idx, Tree_beforeweight] = define_tree(tree_Weight_data1,Ln,k,dim,Energy_In,rng_set)%,Weightinitial)
