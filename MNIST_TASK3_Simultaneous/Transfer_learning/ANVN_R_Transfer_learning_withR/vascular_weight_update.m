function [Tree_Weight, wallowable] = vascular_weight_update(Tree_Weight, wallowable, actv_leaf_idx, actv_leaf_level,eta,Tree_Ntot,Tree_A,Tree_Nlevel,Tree_beforeweight)
    ...
    for i = 1:Tree_Nlevel-1
        ...
        if i==Tree_Nlevel -1
            wallowable = wallowable + eta*sum(act_level_mat);
        end
    end
